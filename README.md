...
| Consultation History | Security and Authentication |
| :---: | :---: | :---: |
| <img src="Screenshot 2026-04-05 195942.png" width="100%" alt="Consultation History Log" /> | <img src="Screenshot 2026-04-28 120138.png" width="100%" alt="Sign In and Access" /> |
| A historical record of previous consultation summaries. | Secure access interface featuring Google login and email sign-in.
